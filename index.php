...
<head>
  ...
  * License: https://bootstrapmade.com/license/
  ...
  <script async src="https://www.googletagmanager.com/gtag/js?id=G-8BFC1F8N81"></script>
  <script>
    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());

    gtag('config', 'G-8BFC1F8N81');
  </script>
...
<body>
  ...
  <section id="hero" class="d-flex flex-column justify-content-center">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-xl-12">
          <h1>The First “Truly Digital Events Place” in the Philippines</h1>
          <a href="#services" class="get-started-btn scrollto">Get Started</a>
  ...
  <main id="main">
    ...
    <section id="services" class="services">
      <div class="container">
        ...
        <div class="section-title">
          <h2>DIGITAL EVENTS PLACE <span style="font-size: 40px;">@</span> THE PARC: <br> YOUR NEWEST VENUE UNDER THE NEW NORMAL</h2>
          <p>Globaltronics and The Performing Arts and Recreation Center (PARC) Foundation strengthened their partnership by transforming several of the latter’s spaces into a one-stop digital events place for businesses, individuals, artists, families, and others.</p>
        </div>
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch">
            <div class="icon-box">
              ...
              <h4><a href="">HEALTH AND SAFETY PROTOCOLS</a></h4>
              <p>With our newest digital events venue, more industries can now thrive under the new normal while assuring health and safety.</p>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4 mt-md-0">
            <div class="icon-box">
              ...
              <p>Entertain your virtual attendees with  our vibrant and high-quality digital solutions combined with top-of-the-line audiovisual equipment.</p>
            </div>
          </div>
          ...
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>We have professional creative artists who can transform your ideas into amazing virtual events.</p>
              <br>
          ...
          <div class="col-lg-6 col-md-6 d-flex align-items-stretch mt-4">
            <div class="icon-box">
              ...
              <p>Aside from the digital spaces, DigiPARC also has multi-purpose rooms close to the digital spaces.</p>
              <br>
     ...
     <section id="pricing" class="pricing">
      <div class="container">
        ...
        <div class="section-title">
          <h2>MAIN SPACES</h2>
          <p class="bold">DigiPARC is now serving your digital needs for both corporate and private events like meetings, product launches, webinars, live sessions, event performances, parties, and others.</p><br>
          <p class="bold">Traditional events that were done physically before can now be conducted here in our innovative studios digitally.</p>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="box">
              <img src="/assets/img/Blackbox/BB 1024x768_1632524850.webp" alt="">
              <h3>BLACK BOX</h3>
              <p>The contrast of the 3-sided LED walls and the dark ambiance brings your events to a whole new level.</p>
          ...
          <div class="col-lg-6 col-md-6 mt-4 mt-lg-0">
            <div class="box">
              <img src="/assets/img/gallery/Gallery 1024x768_1632524850.webp" alt="">
              <h3>GALLERY</h3>
              <p>It has an L-shaped video wall made from Philips commercial screens, iPosters, and teleprompters perfect for small virtual events.</p>
        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="box">
              <img src="/assets/img/creativity/CREATIVITY-HALL-1024x768-(FRONT) (1).webp" alt="">
              <h3>CREATIVITY HALL</h3>
              <p>It is equipped with U-shaped LED walls, a stunning floor LED, and large teleprompter screens perfect for bigger virtual events.</p>
              <!-- <h4><sup>$</sup>0<span> / month</span></h4> -->
              <!-- <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
          ...
          <div class="col-lg-6 col-md-6"> 
            <div class="box">
              <img src="/assets/img/whitebox/WHITEBOX-1024x768-(Front) new1 (1) (1).webp" alt="">
              <h3>WHITE BOX STUDIO</h3>
              <p>You can also maximize your experience at our White Box Studio for your photography or videography needs.</p>
              <!-- <h4><sup>$</sup>0<span> / month</span></h4> -->
              <!-- <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
        ...
        <div class="row mt-4">
          ...
          <div class="col-lg-6 col-md-6">
            <div class="box">
              <img src="/assets/img/Wilmers Hall/Wilmer's Hall 1024x768.webp" alt="">
              <h3>WILMER ONG GUIDO HALL</h3>
              <p>This wide function room is perfect for dancing, job fairs, exhibits, conferences, wedding receptions, and others.</p>
              <!-- <h4><sup>$</sup>0<span> / month</span></h4> -->
              <!-- <ul>
                <li>Aida dere</li>
                <li>Nec feugiat nisl</li>
    ...
    <section id="services" class="services">
      <div class="container">
        <div class="section-title">
          <h2>VIRTUAL TOUR</h2>
          <h3>Explore DigiPARC at the comfort of your homes.</h3>
          <br>
              ...
              <div class="container">
                ...
                <div class="portfolio-details-container">
                  ...
                  <div class="owl-carousel portfolio-details-carousel">
                    <img src="assets/img/Wilmers Hall/WOG1-1200x695-(SLider-for-more-details (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/Wilmers Hall/WOG3-1200x695-(SLider-for-more-details (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/Wilmers Hall/WOG5-1200x695-(SLider-for-more-details (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/Wilmers Hall/WOG6-1200x695-(SLider-for-more-details (1).webp" class="img-fluid" alt="">
                  </div>
                        <!-- 
            ...
            <section id="portfolio-details" class="portfolio-details">
              <div class="container">
                ...
                <div class="portfolio-details-container">
                  ...
                  <div class="owl-carousel portfolio-details-carousel">
                    <img src="assets/img/Blackbox/BB-1.webp" class="img-fluid" alt="">
                    <img src="assets/img/Blackbox/BB-2 (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/Blackbox/BB-3 (1).webp" class="img-fluid" alt="">
                  </div>
            ...
            <section id="portfolio-details" class="portfolio-details">
              <div class="container">
                ...
                <div class="portfolio-details-container">
                  ...
                  <div class="owl-carousel portfolio-details-carousel">
                    <img src="assets/img/gallery/GALLERY-1200x695-(SLider-for-more-details (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/gallery/Gallery-1 (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/gallery/Gallery-2 (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/gallery/Gallery-3 (1).webp" class="img-fluid" alt="">
                  </div>
            ...
            <section id="portfolio-details" class="portfolio-details">
              <div class="container">
                ...
                <div class="portfolio-details-container">
                  ...
                  <div class="owl-carousel portfolio-details-carousel">
                    <img src="assets/img/creativity/CREATIVITY-HALL-1200x695-(SLider-for-more-details (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/creativity/CH-1 (1).webp" class="img-fluid" alt="">
                    <img src="assets/img/creativity/CH-2 (1).webp" class="img-fluid" alt="">
            ...
            <section id="portfolio-details" class="portfolio-details">
              <div class="container">
                ...
                <div class="portfolio-details-container">
                  ...
                  <div class="owl-carousel portfolio-details-carousel">
                    <img src="assets/img/whitebox/WHITEBOX-1200x695-(SLider-for-more-details rev1 (1).webp" class="img-fluid" alt="">
                  </div>
     ...
     <section id="counts" class="counts">
      <div class="container">
        ...
        <div class="text-center title">
          ...
          <p>For more than 18 years, Globaltronics has been the leading channel for enlightening people’s lives through digital innovation. In the future years, it will continue to serve the digital needs of several industries across the country, crisis or no crisis.</p>
        </div>
      ...
      <div class="container">
        ...
        <div class="row portfolio-container">
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-2020">
            <img src="assets/img/events/2020/Spirit of Giving 2020 A Charity Online Concert (2).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Spirit of Giving 2020</h4>
              <p>BLACKBOX</p>
              <a href="assets/img/events/2020/Spirit of Giving 2020 A Charity Online Concert (2).webp" data-gall="portfolioGallery" class="venobox preview-link" title="Spirit of Giving 2020 A Charity Online Concert"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-2020">
            <img src="assets/img/events/2020/15th International ICT Awards - Philippines (1).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>15th International ICT Awards</h4>
              <p>BLACKBOX</p>
              <a href="assets/img/events/2020/15th International ICT Awards - Philippines (1).webp" data-gall="portfolioGallery" class="venobox preview-link" title="15th International ICT Awards - Philippines"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <img src="assets/img/events/2021/Chinoy TV 1 (1).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>CHINOY TV</h4>
              <p>BLACKBOX</p>
              <a href="assets/img/events/2021/Chinoy TV 1 (1).webp" data-gall="portfolioGallery" class="venobox preview-link" title="CHINOY TV"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>
 
          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <img src="assets/img/events/2021/DXN (1).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>DXN</h4>
              <p>GALLERY</p>
              <a href="assets/img/events/2021/DXN (1).webp" data-gall="portfolioGallery" class="venobox preview-link" title="DXN"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <img src="assets/img/events/2021/King Herbals (1).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>King Herbals</h4>
              <p>GALLERY</p>
              <a href="assets/img/events/2021/King Herbals (1).webp" data-gall="portfolioGallery" class="venobox preview-link" title="King Herbals"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <img src="assets/img/events/2021/Road to KoreaTayoSoon Live Event (1).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Road to #KoreaTayoSoon</h4>
              <p>BLACKBOX</p>
              <a href="assets/img/events/2021/Road to KoreaTayoSoon Live Event (1).webp" data-gall="portfolioGallery" class="venobox preview-link" title="Road to #KoreaTayoSoon"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <img src="assets/img/events/2021/Tanduay Calendar Girl (2021)(1).webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Tanduay Calendar Girl (2021)</h4>
              <p>CREATIVITY HALL</p>
              <a href="assets/img/events/2021/Tanduay Calendar Girl (2021)(1).webp" data-gall="portfolioGallery" class="venobox preview-link" title="Tanduay Calendar Girl (2021)"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>

          <div class="col-lg-4 col-md-6 portfolio-item filter-2021">
            <img src="assets/img/events/2021/DigiPARC-Brilliant-0342-1.webp" class="img-fluid" alt="">
            <div class="portfolio-info">
              <h4>Brilliant</h4>
              <p>GALLERY</p>
              <a href="assets/img/events/2021/DigiPARC-Brilliant-0342-1.webp" data-gall="portfolioGallery" class="venobox preview-link" title="BRILLIANT"><i class="bx bx-zoom-in"></i></a>
              <!-- <a href="portfolio-details.html" class="details-link" title="More Details"><i class="bx bx-link"></i></a> -->
            </div>
          </div>
              ...
              <div class="carousel-inner" role="listbox">
                  <div class="carousel-item active">
                      <div class="testimonial4_slide">
                          <img src="assets/img/testimonial/FrankMamaril.webp" class="img-circle img-responsive" />
                  ...
                  <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img src="assets/img/testimonial/AlbertNicolas.webp" class="img-circle img-responsive" />
                        <p>"WITH THE POST-PANDEMIC,  WE NEED TO ADAPT TO THE NEW CHANGES. BUT HERE AT DIGIPARC, TRADITIONAL EVENTS CAN STILL BE CONDUCTED THE BEST POSSIBLE WAY."</p>
                        <h4>- ALBERT NICOLAS A.K.A ASIAN CUTIE, TV PERSONALITY</h4>
                    </div>
                  </div>
                  <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img src="assets/img/testimonial/FroilanAmbrocio.webp" class="img-circle img-responsive" />
                        <p>"I HIGHLY RECOMMEND DIGIPARC TO ALL THE PRODUCTION HOUSES. I’M SURE THAT THERE IS A SPACE THAT FITS YOUR REQUIREMENT."</p>
                        <h4>- FROILAN AMBROCIO, LIGHTHOUSE EVENTS /PRESIDENT AND MANAGING PARTNER</h4>
                    </div>
                  </div>
                  <div class="carousel-item">
                      <div class="testimonial4_slide">
                          <img src="assets/img/testimonial/CYNTHIAPAGDILAO.webp" class="img-circle img-responsive" />
                  ...
                  <div class="carousel-item">
                      <div class="testimonial4_slide">
                          <img src="assets/img/testimonial/MarkCristianMorales.webp" class="img-circle img-responsive" />
                  ...
                  <div class="carousel-item">
                    <div class="testimonial4_slide">
                        <img src="assets/img/testimonial/IvyDeGuzman.webp" class="img-circle img-responsive" />
                ...
                <div class="carousel-item">
                  <div class="testimonial4_slide">
                      <img src="assets/img/testimonial/AlvinTan.webp" class="img-circle img-responsive" />
                ...
                <div class="carousel-item">
                  <div class="testimonial4_slide">
                      <img src="assets/img/testimonial/CeciliaCatapang.webp" class="img-circle img-responsive" />
                ...
                <div class="carousel-item">
                  <div class="testimonial4_slide">
                      <img src="assets/img/testimonial/MasterHanz.webp" class="img-circle img-responsive" />
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-8 mt-5 mt-lg-0">
            ...
            <form action="https://formsubmit.co/ggc@globaltronics.net" method="POST" role="form" class="php-email-form">
              <div class="form-row">
